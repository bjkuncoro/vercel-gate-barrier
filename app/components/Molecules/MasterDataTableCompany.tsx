...
const MasterDataTableCompany = () => {
  const { fetchCompany, loading, companyList } = useAuth();
  ...
  const columns = [
    ...
    {
      name: 'Jumlah Pengurus/Pegawai',
      selector: (row: any) => {
        const employeeCount = row.employees.length;
        return employeeCount > 0 ? `${employeeCount} orang` : 'Tidak ada';
      },
      sortable: true
    },
    {
...
export default MasterDataTableCompany;
